...
require(R.utils)
library(parallel)
dirfile <- dirname(rstudioapi::getSourceEditorContext()$path)
sourceDirectory(paste0(dirfile, "/funcionesFMM/"),modifiedOnly=F)
source(paste0(dirfile, "/auxMultiFMMPlot.R"))
source(paste0(dirfile, "/precissionMatrix.R"))
